...
if st.button("Submit For Prediction"):
    ...
    pred_probe = model.predict_proba(new_data)[0][1]
    
    # output prediction
    st.subheader(f"Based on these customer attributes, our model predicts a purchase probability of {pred_probe:.0%}")